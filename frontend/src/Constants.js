...
export const DEFAULT_CONFIG = { "color_mode": "RGB", "res_w":64,"res_h":64, "population_size": 18, "activations": ["identity", "gauss", "sin", "cos", "sawtooth", "tanh", "sigmoid"], "output_activation": "tanh" }
